...
import { FaSignInAlt, FaUser, FaEnvelope, FaLock , FaEye, FaEyeSlash } from 'react-icons/fa';
  ...
  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen bg-custom-gray overflow-hidden">
      ...
      <div className="w-full md:w-1/2 h-screen flex flex-col justify-center items-center bg-custom-gray relative z-10 px-4 md:px-8">
        ...
        <h1 className="text-2xl font-semibold text-white text-center">Welcome to Eladdin</h1>
        <h1 className="text-2xl font-semibold mb-3 text-white text-center">AI Agent</h1>
